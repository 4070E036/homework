<?php 
    ...
    if (isset($_POST['email'])) {
        ...
        if ($result->num_rows > 0){ // 是已註冊的 Email
            ...
            /* 寄信者的SMTP帳號 */
            $mail->Username =  "xxxxxs@gmail.com"; // $cms_gmailname;
            /* 寄信者的SMTP密碼 */
            $mail->Password = 'wtyreyetuuw'; // 二段式驗證密碼（16字)
            ...
            /* 回信的電子郵件 */
            $mail->addReplyTo("xxxxxxxxx@gmail.com", "Chin-Tsai Lin");
            /* 信件主旨 */
            $mail->Subject = "重置密碼";
            /* 設定斷行字數 */
            // $mail->WordWrap = 50;
            ...
            'http://4070e029.ctlin.ml/ch12/reset_password.php?email=$email&token=$token'
            4070e029敬上");
