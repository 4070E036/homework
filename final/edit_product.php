        ...
        <form method="POST" action="update_product.php" enctype="multipart/form-data" class="formsty">
            <div class="formtab">
                ...
                <select id="category" name="category_id">
                    <option value="1"<?php if ($category_id == 1) echo ' selected'; ?>>營業據點查詢</option>
                    <option value="2"<?php if ($category_id == 2) echo ' selected'; ?>>購車試算</option>
                    <option value="3"<?php if ($category_id == 3) echo ' selected'; ?>>購車優惠</option>
                </select>
                <li class="L">
